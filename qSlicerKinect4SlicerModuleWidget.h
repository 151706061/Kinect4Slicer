...
public:
  ...
  void CreateTransformationModel(vtkMRMLLinearTransformNode* transformation, double r, double g, double b);
...
private:
  ...
  int ThreadID;
  //BTX
  itk::MultiThreader::Pointer itkThreadPointer;
  //ETX

  vtkMRMLKinectSensorNode* KinectSensor;
